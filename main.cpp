#include <iostream>
import BPZ1901.Grigorieva.Task1;
import BPZ1901.Grigorieva.Task2;
import BPZ1901.Grigorieva.Task3;
import BPZ1901.Grigorieva.Task4;
import BPZ1901.Grigorieva.Task5;
...
int main() {
	...
	double eps;
	int n;
	cout << "X will be equal to?: ";
	cin >> x;
	cout << "Eps error value will be?: ";
	cin >> eps;
	cout << "How much iterations?: ";
	cin >> n;
	while (true) {
		int choose = 1;
		...
		case 6:
			...
			return 0;
		default:
			printf("Inccroect data! Try again.\n");
		}
	}
	return 0;
}
